...
export class UIBuilder {
    static createTextArea(className, placeholder = "", readonly = false) {
    ...
    static createUI() {
        ...
        const decryptButton = this.createButton("button-secondary", "Descriptografar");
        ...
        new MessageHandler(textInput, textOutput, encryptButton, decryptButton, copyButton, outputTitle);
    }
}
